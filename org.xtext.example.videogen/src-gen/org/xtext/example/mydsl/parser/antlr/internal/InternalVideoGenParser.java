...
public class InternalVideoGenParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_LEFT_BRACKET", "RULE_RIGHT_BRACKET", "RULE_STRING", "RULE_ID", "RULE_INT", "RULE_PERCENTAGE", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'VideoGen'", "'@author'", "'@version'", "'@creation'", "'mandatory'", "'optional'", "'alternatives'", "'image'", "'toptext'", "'bottomtext'", "'videoseq'", "'duration'", "'probability'", "'description'", "'filter'", "'text'", "'content'", "'position'", "'color'", "'size'", "'TOP'", "'BOTTOM'", "'CENTER'", "'b&w'", "'negate'", "'flip'", "'h'", "'horizontal'", "'v'", "'vertical'"
    };
        ...
        try {
            ...
            switch (alt17) {
                case 1 :
                    ...
                    // InternalVideoGen.g:665:4: (otherlv_6= 'probability' ( (lv_probability_7_0= RULE_PERCENTAGE ) ) )?
                    int alt13=2;
                    ...
                    switch (alt13) {
                        case 1 :
                            // InternalVideoGen.g:666:5: otherlv_6= 'probability' ( (lv_probability_7_0= RULE_PERCENTAGE ) )
                            {
                            ...
                            // InternalVideoGen.g:670:5: ( (lv_probability_7_0= RULE_PERCENTAGE ) )
                            // InternalVideoGen.g:671:6: (lv_probability_7_0= RULE_PERCENTAGE )
                            {
                            // InternalVideoGen.g:671:6: (lv_probability_7_0= RULE_PERCENTAGE )
                            // InternalVideoGen.g:672:7: lv_probability_7_0= RULE_PERCENTAGE
                            {
                            lv_probability_7_0=(Token)match(input,RULE_PERCENTAGE,FOLLOW_22); 
    ...
    public final EObject ruleVideoText() throws RecognitionException {
        ...
        try {
            ...
            {
            this_LEFT_BRACKET_0=(Token)match(input,RULE_LEFT_BRACKET,FOLLOW_26); 
            ...
            switch (alt18) {
                case 1 :
                    ...
                    {
                    lv_color_6_0=(Token)match(input,RULE_STRING,FOLLOW_30); 
    ...
    public static final BitSet FOLLOW_6 = new BitSet(new long[]{0x00000000001C0020L});
    ...
    public static final BitSet FOLLOW_12 = new BitSet(new long[]{0x0000000001200020L});
    ...
    public static final BitSet FOLLOW_18 = new BitSet(new long[]{0x000000003E000020L});
    public static final BitSet FOLLOW_19 = new BitSet(new long[]{0x0000000000000100L});
    public static final BitSet FOLLOW_20 = new BitSet(new long[]{0x000000003C000020L});
    public static final BitSet FOLLOW_21 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_22 = new BitSet(new long[]{0x0000000038000020L});
    public static final BitSet FOLLOW_23 = new BitSet(new long[]{0x0000000030000020L});
    ...
    public static final BitSet FOLLOW_29 = new BitSet(new long[]{0x0000000300000020L});
