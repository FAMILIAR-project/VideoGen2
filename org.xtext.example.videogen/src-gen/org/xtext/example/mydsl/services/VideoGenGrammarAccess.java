...
public class VideoGenGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MandatoryMediaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.VideoGen.MandatoryMedia");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OptionalMediaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.VideoGen.OptionalMedia");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AlternativesMediaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.VideoGen.AlternativesMedia");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MediaDescriptionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.VideoGen.MediaDescription");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class VideoDescriptionElements extends AbstractParserRuleElementFinder {
		...
		//	probability=PERCENTAGE)? ('description' description=STRING)? ('filter' filter=Filter)? ('text' text=VideoText)? // incrust a text into a video
		//	RIGHT_BRACKET)?;
		@Override public ParserRule getRule() { return rule; }
	...
	public class VideoTextElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.VideoGen.VideoText");
		private final Group cGroup = (Group)rule.eContents().get(1);
