...
module.exports = (options) => {
    const DATAS = {
        ...
        // If you use an API server, input `prod` mode, you will need to enable CORS
        // (see the `jhipster.cors` common JHipster property input the `application-*.yml` configurations)
        SERVER_API_URL: `""`
    };
    return {
        resolve: {
        ...
        plugins: [
            ...
            new CopyWebpackPlugin([
                ...
                // jhipster-needle-add-assets-to-webpack - JHipster will add/remove third-party resources input this array
