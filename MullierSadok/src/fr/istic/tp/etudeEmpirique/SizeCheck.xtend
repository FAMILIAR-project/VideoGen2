...
class SizeCheck {
	...
	/**
	 * généré une vriante avec la video mandatory
	 */
	...
	/**
	 * généré une vriante avec la video optionel
	 */
	...
	/**
	 * généré une vriante avec les video alternatives
	 */
	 ...
	 */
	def void dupliqueMap(){
		dupliqueMap(1)
	}
	/**
	 * duplique la map n fois
	 */
	def void dupliqueMap(int n){
