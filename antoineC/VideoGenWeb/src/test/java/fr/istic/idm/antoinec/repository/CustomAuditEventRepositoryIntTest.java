...
import fr.istic.idm.antoinec.config.audit.AuditEventConverter;
import fr.istic.idm.antoinec.domain.PersistentAuditEvent;
...
import static fr.istic.idm.antoinec.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
