		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMediaDescriptionAccess().getAlternatives(), "rule__MediaDescription__Alternatives");
					...
					put(grammarAccess.getMandatoryMediaAccess().getGroup(), "rule__MandatoryMedia__Group__0");
					put(grammarAccess.getOptionalMediaAccess().getGroup(), "rule__OptionalMedia__Group__0");
					put(grammarAccess.getAlternativesMediaAccess().getGroup(), "rule__AlternativesMedia__Group__0");
					...
					put(grammarAccess.getVideoTextAccess().getGroup(), "rule__VideoText__Group__0");
					put(grammarAccess.getVideoTextAccess().getGroup_5(), "rule__VideoText__Group_5__0");
					put(grammarAccess.getVideoTextAccess().getGroup_6(), "rule__VideoText__Group_6__0");
					...
					put(grammarAccess.getVideoGeneratorModelAccess().getInformationAssignment_0(), "rule__VideoGeneratorModel__InformationAssignment_0");
					put(grammarAccess.getVideoGeneratorModelAccess().getMediasAssignment_3(), "rule__VideoGeneratorModel__MediasAssignment_3");
					...
					put(grammarAccess.getMandatoryMediaAccess().getDescriptionAssignment_1(), "rule__MandatoryMedia__DescriptionAssignment_1");
					put(grammarAccess.getOptionalMediaAccess().getDescriptionAssignment_1(), "rule__OptionalMedia__DescriptionAssignment_1");
					put(grammarAccess.getAlternativesMediaAccess().getIdAssignment_1(), "rule__AlternativesMedia__IdAssignment_1");
					put(grammarAccess.getAlternativesMediaAccess().getMediasAssignment_3(), "rule__AlternativesMedia__MediasAssignment_3");
					...
					put(grammarAccess.getVideoTextAccess().getContentAssignment_2(), "rule__VideoText__ContentAssignment_2");
					put(grammarAccess.getVideoTextAccess().getPositionAssignment_4(), "rule__VideoText__PositionAssignment_4");
					put(grammarAccess.getVideoTextAccess().getColorAssignment_5_1(), "rule__VideoText__ColorAssignment_5_1");
					put(grammarAccess.getVideoTextAccess().getSizeAssignment_6_1(), "rule__VideoText__SizeAssignment_6_1");
